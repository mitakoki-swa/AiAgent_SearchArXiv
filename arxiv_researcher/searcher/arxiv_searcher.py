...
class ArxivTimeRange(BaseModel):
    start: Optional[datetime.datetime] = Field(
        ...
        default=None,
        description="The end date of the time range to be retrieved."
    )
...
class ArxivSearcher(Searcher):
    ...
    def _field_selection(self, query: str) -> ArxivFields:
    ...
    def _date_selector(self, query: str) -> ArxivTimeRange:
        ...
        return chain.invoke({"query": query, "current_date": self.current_date})
